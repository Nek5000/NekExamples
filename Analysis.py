...
Run("Example 2d_eig/PGI: Serial-iter/err",log,value)
#GNU
log = "./gnuLog/eig1.err"
value = [[' 2   ',19,2,6],
         [' 2   ',1.6329577E-01,1e-06,2],
         ...
         [' 10  ',400,2,6],
         [' 10  ',6.8264260E-06,1e-06,2]]
Run("Example 2d_eig/GNU: Serial-iter/err",log,value)
#INT
log = "./intLog/eig1.err"
value = [[' 2   ',19,2,6],
         [' 2   ',1.6329577E-01,1e-06,2],
         ...
         [' 10  ',400,2,6],
         [' 10  ',6.8264260E-06,1e-06,2]]
Run("Example 2d_eig/INT: Serial-iter/err",log,value)
#PGI2
log = "./pgi2Log/eig1.err"
value = [[' 2   ',19,2,6],
         [' 2   ',1.6329577E-01,1e-06,2],
         [' 3   ',37,2,6],
         [' 3   ',1.4437432E-01,1e-06,2],
         ...
         [' 10  ',400,2,6],
         [' 10  ',6.8264260E-06,1e-06,2]]
Run("Example 2d_eig/PGI2: Serial-iter/err",log,value)
#GNU2
log = "./gnu2Log/eig1.err"
value = [[' 2   ',19,2,6],
         [' 2   ',1.6329577E-01,1e-06,2],
         [' 3   ',37,2,6],
         [' 3   ',1.4437432E-01,1e-06,2],
         ...
         [' 10  ',400,2,6],
         [' 10  ',6.8264260E-06,1e-06,2]]
Run("Example 2d_eig/GNU2: Serial-iter/err",log,value)
#INT2
log = "./int2Log/eig1.err"
value = [[' 2   ',19,2,6],
         [' 2   ',1.6329577E-01,1e-06,2],
         [' 3   ',37,2,6],
         [' 3   ',1.4437432E-01,1e-06,2],
         ...
         [' 10  ',400,2,6],
         [' 10  ',6.8264260E-06,1e-06,2]]
Run("Example 2d_eig/INT2: Serial-iter/err",log,value)
